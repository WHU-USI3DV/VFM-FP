...
- Dataset files, generated images, additional pretrained weights, and model caches should not be redistributed until their licenses are confirmed. `VCFS/model_data/deeplab_mobilenetv2.pth` is included as the default checkpoint.

## Before Public Release

- Revisit whether a root `LICENSE` should be added.
...
Keep datasets and generated assets outside git. Provide external download instructions for datasets and any additional weights after verifying redistribution rights.

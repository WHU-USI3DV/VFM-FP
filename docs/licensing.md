...
- The project owner chose not to add a root project `LICENSE` in this cleanup pass.
...
Publishing without a root license means reuse rights are not explicitly granted for the project-owned code. This is an owner decision for the current cleanup pass, not a technical requirement.

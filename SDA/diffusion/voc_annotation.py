...
if __name__ == "__main__":
    ...
    # segfilepath     = os.path.join(VOCdevkit_path, 'syn_GT')
    # saveBasePath    = os.path.join(VOCdevkit_path, 'txt1')

    segfilepath     = os.path.join(VOCdevkit_path, 'diversity/SegmentationClass')
    saveBasePath    = os.path.join(VOCdevkit_path, 'diversity/txt')

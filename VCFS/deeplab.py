...
class DeeplabV3(object):
    """Inference wrapper for VCFS/DeepLabv3+ checkpoints."""

    _defaults = {
        #   model_path points to a checkpoint under results/ by default.
        #   Choose the checkpoint with suitable validation behavior after training.
        # "model_path"        : 'model_data/deeplab_mobilenetv2.pth',
        "model_path"        : 'results/last_epoch_weights.pth',

        "num_classes"       : 7,#7
        "backbone"          : "mobilenet",
        "input_shape"       : [512, 512],
        "downsample_factor" : 8,
        # mix_type: 0 blends mask with image, 1 returns only the colored mask,
        # and 2 keeps only non-background image pixels.
        "mix_type"          : 1,
        "cuda"              : True,
        "class_config"      : None,
    }
